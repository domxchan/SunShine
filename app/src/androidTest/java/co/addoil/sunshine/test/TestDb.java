...
public class TestDb extends AndroidTestCase {
    ...
    public static final String TEST_POSTAL_CODE = "90210";
    public static final String TEST_LOCATION_NAME = "Hollywood";
    public static final String TEST_DATE = "20140505";
...
// Create a new map of values, where column names are the keys
        ...
        testValues.put(LocationEntry.COLUMN_POSTAL_CODE, TEST_POSTAL_CODE);
        testValues.put(LocationEntry.COLUMN_LOCATION_NAME, TEST_LOCATION_NAME);
