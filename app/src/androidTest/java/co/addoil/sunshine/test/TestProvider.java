...
// Create a new map of values, where column names are the keys
        ...
        testValues.put(LocationEntry.COLUMN_POSTAL_CODE, KALAMAZOO_LOCATION_SETTING);
        testValues.put(LocationEntry.COLUMN_LOCATION_NAME, "Kalamazoo");
    ...
    public void insertKalamazooData() {
        ...
        Log.d(LOG_TAG, "insertKalamazooData, locationInsertUri: " + locationInsertUri);
        locationRowId = ContentUris.parseId(locationInsertUri);
...
// Make the same update to the full ContentValues for comparison.
    ...
    public void testRemoveHumidityAndReadWeather() {
        ...
        Log.d(LOG_TAG, "Content URI: " + WeatherEntry.CONTENT_URI);
        Log.d(LOG_TAG, "selection: " + WeatherEntry.COLUMN_HUMIDITY + " = " + locationRowId);
...
// Make the same update to the full ContentValues for comparison.
        ...
        Log.d(LOG_TAG, "KalamazooAltered values: " + kalamazooAltered);
        TestDb.validateCursor(weatherCursor, kalamazooAltered);
